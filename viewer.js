...
var typeColors = { ...DEFAULT_TYPE_COLORS };
var nodeTypes = {};
...
async function render() {
  ...
  try {
    ...
    let bottomQ = phoneFocusNodeId && graph.nodes.get(phoneFocusNodeId)?.kind === "question" ? phoneFocusNodeId : undefined;
    if (!bottomQ) {
